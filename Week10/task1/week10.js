...
const S = (calculateArea(width,height));
console.log (S);
...
const result = (secondFunction(78,98));
console.log (result); 
...
const result=(thirdFunction(25,2));
...
function greetingGuest (guestName='Гость'){
	return (`Привет,  ${guestName}!`);
}
console.log(greetingGuest('Настя'));
...
console.log(calculateDifference(15, 3)); 
...
const calculateProduct = function(c,d){
return c*d;
};
...
function calculateYearsSinceLastOlympics() {
	return yearNow - lastOlympicsYear;
}
console.log(
...
const friendYearOfBirth = 1989;
const yearNow =2023;
function calculateAge() {
	return yearNow - friendYearOfBirth;
}
console.log(
	'Возраст пользователя ' + calculateAge() + '.');
